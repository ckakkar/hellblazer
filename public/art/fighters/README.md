...
- `rei.webp` — Rei Mikazuchi
- `setsuna.webp` — Setsuna Kiryu
- `hatsumi.webp` — Sen Hatsumi
- `gaolang.webp` — Gaolang Wongsawat
- `julius.webp` — Julius Reinhold
- `raian.webp` — Raian Kure
- `wakatsuki.webp` — Wakatsuki Takeshi
- `ohma.webp` — Ohma Tokita
- `agito.webp` — Kanoh Agito
- `kuroki.webp` — Kuroki Gensai
